...
export default function HeavenlandParkPage() {
    ...
    async function fetchBanner() {
        try {
            const res = await fetch('http://127.0.0.1:8000/api/banners/heavenland-park', { cache: 'no-store' });
            if (res.ok) {
    ...
    const googleMapsUrl = "https://maps.google.com/?q=Heavenland+Park+Sidoarjo";
                        ...
                        <div className="lg:col-span-5 space-y-3.5 text-center lg:text-left order-2 lg:order-1">
                            <div className="space-y-1.5">
                                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#f4ece1] text-[#8c5a3c] text-[10px] sm:text-xs font-black tracking-wider uppercase border border-[#e6ccb2]/80">
                                    <span>CABANG 1 • OUTDOOR & PLAYGROUND</span>
                                </div>
                                ...
                                <p className="text-xs sm:text-sm text-[#5a4232] font-semibold leading-relaxed max-w-sm mx-auto lg:mx-0">
                                    {banner?.subtitle || 'Kami tidak sabar menyambut kedatanganmu di To Meet Cafe & Playground Heavenland Park.'}
                                </p>
                            </div>
                            ...
                            <div className="inline-flex items-center gap-2 py-2 px-3.5 rounded-2xl bg-[#fffcf7] border border-[#e6ccb2]/80 shadow-2xs">
                                ...
                                <span className="text-[11px] font-black text-[#3d2314]">
                                    Datang untuk mencicipi hidangan, tinggal untuk kenangannya!
                                </span>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                        ...
                        <div className="lg:col-span-5 space-y-4">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-xl bg-[#f4ece1] text-[#e85a4f] flex items-center justify-center">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <p className="text-xs text-[#5a4232] font-semibold leading-relaxed">
                                    Jl. Raya Pralajur, Heavenland Park, Sidoarjo, Jawa Timur 61257<br />
                                    <span className="text-[11px] text-[#6c584c]">(Area dalam kawasan Heavenland Park)</span>
                                </p>
                            </div>
                        ...
                        <div className="lg:col-span-7">
                            <div className="w-full h-56 sm:h-64 rounded-2xl overflow-hidden border border-[#e6ccb2]/70 shadow-2xs bg-stone-100">
                                <iframe
                                    ...
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.273641774301!2d112.7155609!3d-7.4349383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7e6ae9603099b%3A0x6b48455e963b65e9!2sHeavenland%20Park!5e0!3m2!1sid!2sid!4v1715000000000!5m2!1sid!2sid"
                                    width="100%"
                                    height="100%"
                                    style={{ border: 0 }}
                                    allowFullScreen
                            ...
                            <div className="space-y-2.5 text-xs">
                                <div className="space-y-0.5">
                                    <div className="font-bold text-[#3d2314] flex items-center gap-1.5">
                                        ...
                                        <span>Kendaraan Pribadi (Mobil / Motor)</span>
                                    </div>
                                    <p className="text-[11px] text-[#6c584c] font-semibold pl-5">
                                        Akses jalan masuk lebar dan parkir langsung di dalam Heavenland Park.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-[11px] text-[#6c584c] font-semibold pl-5">
                                        Cari kata kunci: &quot;To Meet Cafe Heavenland Park&quot;.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-0.5">
                                    <div className="font-bold text-[#3d2314] flex items-center gap-1.5">
                                        ...
                                        <span>Transportasi Publik / Online</span>
                                    </div>
                                    <p className="text-[11px] text-[#6c584c] font-semibold pl-5">
                                        Bisa menggunakan ojek/taksi online dengan titik jemput lobi cafe.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-3 text-xs">
                                <div className="p-3 bg-[#faf6f0] rounded-2xl border border-[#e6ccb2]/60 space-y-1">
                                    <div className="font-black text-[#3d2314]">Parkir Mobil Luas</div>
                                    <p className="text-[11px] text-[#6c584c] font-semibold leading-relaxed">
                                        Tersedia area parkir mobil khusus pengunjung cafe yang aman di dalam kompleks.
                                    </p>
                                </div>

                                <div className="p-3 bg-[#faf6f0] rounded-2xl border border-[#e6ccb2]/60 space-y-1">
                                    <div className="font-black text-[#3d2314]">Parkir Sepeda Motor</div>
                                    <p className="text-[11px] text-[#6c584c] font-semibold leading-relaxed">
                                        Lokasi parkir motor dekat dengan pintu masuk utama cafe.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div className="bg-[#fffcf7] p-2 rounded-2xl border border-[#e6ccb2]/70 space-y-1.5 text-center">
                        <div className="w-full aspect-4/3 rounded-xl overflow-hidden bg-stone-100">
                            <img src="/img/hero-home.png" alt="Cozy Cafe Area" className="w-full h-full object-cover" />
                        </div>
                        <h4 className="font-black text-[11px] text-[#3d2314] uppercase">COZY CAFE</h4>
                    </div>

                    <div className="bg-[#fffcf7] p-2 rounded-2xl border border-[#e6ccb2]/70 space-y-1.5 text-center">
                        <div className="w-full aspect-4/3 rounded-xl overflow-hidden bg-stone-100">
                            <img src="/img/hero-home.png" alt="Fun Playground Lantai 3" className="w-full h-full object-cover" />
                        </div>
                        <h4 className="font-black text-[11px] text-[#3d2314] uppercase">FUN PLAYGROUND</h4>
                    </div>

                    <div className="bg-[#fffcf7] p-2 rounded-2xl border border-[#e6ccb2]/70 space-y-1.5 text-center">
                        <div className="w-full aspect-4/3 rounded-xl overflow-hidden bg-stone-100">
                            <img src="/img/hero-home.png" alt="Comfy Seating Area" className="w-full h-full object-cover" />
                        </div>
                        <h4 className="font-black text-[11px] text-[#3d2314] uppercase">COMFY SEATING</h4>
                    </div>

                    <div className="bg-[#fffcf7] p-2 rounded-2xl border border-[#e6ccb2]/70 space-y-1.5 text-center">
                        <div className="w-full aspect-4/3 rounded-xl overflow-hidden bg-stone-100">
                            <img src="/img/hero-home.png" alt="Outdoor Waiting Area" className="w-full h-full object-cover" />
                        </div>
                        <h4 className="font-black text-[11px] text-[#3d2314] uppercase">OUTDOOR AREA</h4>
                    </div>
                </div>
            </section>
                ...
                <div className="bg-[#fffcf7] p-5 sm:p-7 rounded-3xl border border-[#e6ccb2]/80 shadow-2xs space-y-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2.5 text-center">
                        <div className="bg-[#faf6f0] p-2.5 rounded-2xl border border-[#e6ccb2]/60 space-y-1">
                            <Sparkles className="w-4 h-4 text-[#8c5a3c] mx-auto" />
                            <div className="text-[10px] font-black text-[#3d2314]">Kids Playground</div>
                        </div>
                        ...
                        <div className="bg-[#faf6f0] p-2.5 rounded-2xl border border-[#e6ccb2]/60 space-y-1">
                            <Cigarette className="w-4 h-4 text-[#8c5a3c] mx-auto" />
                            <div className="text-[10px] font-black text-[#3d2314]">Smoking Area</div>
                        </div>

                        <div className="bg-[#faf6f0] p-2.5 rounded-2xl border border-[#e6ccb2]/60 space-y-1">
                            <Camera className="w-4 h-4 text-[#8c5a3c] mx-auto" />
                            <div className="text-[10px] font-black text-[#3d2314]">Photo Spot</div>
                        </div>
                    </div>
                </div>
            </section>
